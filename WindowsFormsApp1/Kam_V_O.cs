    ...
    public class CCamera
    {
        ...
        public void OpenCamera(IntPtr hDisplayWnd, LvSystem pSystem)
        {
            try
            {
                ...
                pDevice.SetFloat(LvDeviceFtr.BalanceRatio, 1.124323);
                ...
                pDevice.SetFloat(LvDeviceFtr.BalanceRatio, 1.231665);
                pDevice.SetEnum(LvDeviceFtr.BalanceWhiteAuto, (UInt32)LvBalanceWhiteAuto.Off);
                pDevice.SetFloat(LvDeviceFtr.Gamma, 0.600000);
                // --- LUT Control ---
                ...
                pDevice.SetFloat(LvDeviceFtr.LvUniBalanceRatio, 1.100000);
                ...
                pDevice.SetFloat(LvDeviceFtr.LvUniBalanceRatio, 1.103000);
        ...
        public void SaveImg(LvNewBufferEventArgs e)
        {
            ...
            e.Buffer.SaveImageToJpgFile(@"C:\Users\Damian.Jakubowski\AWICO\Technik - Witt IBC Bilder\VO" + name + ".jpg", 95);
        }
