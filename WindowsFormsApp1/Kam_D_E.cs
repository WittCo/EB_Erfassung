    ...
    public class CCamera5
    {
        ...
        public void OpenCamera(IntPtr hDisplayWnd, LvSystem pSystem)
        {
            try
            {
                ...
                pInterface.OpenDevice("SVGTL:80-6C-BC-30-01-45", ref pDevice, LvDeviceAccess.Control);
                ...
                pDevice.SetInt(LvDeviceFtr.Width, 2592);
                pDevice.SetInt(LvDeviceFtr.Height, 1944);
                pDevice.SetInt(LvDeviceFtr.OffsetX, 0);
                pDevice.SetInt(LvDeviceFtr.OffsetY, 0);
                pDevice.SetEnum(LvDeviceFtr.RegionSelector, (UInt32)LvRegionSelector.Region0);
                pDevice.SetEnumStr(LvDeviceFtr.BinningHorizontal, "x1");
                pDevice.SetEnumStr(LvDeviceFtr.BinningVertical, "x1");
                pDevice.SetInt(LvDeviceFtr.DecimationHorizontal, 1);
                pDevice.SetInt(LvDeviceFtr.DecimationVertical, 1);
                ...
                pDevice.SetEnumStr(Ftr_TestPatternGeneratorSelector, "Sensor");
                // --- Acquisition ---
                pDevice.SetEnum(LvDeviceFtr.AcquisitionMode, (UInt32)LvAcquisitionMode.SingleFrame);
                ...
                pDevice.SetFloat(LvDeviceFtr.ExposureTime, 49414.191406);
                ...
                // --- LUT Control ---
                pDevice.SetEnum(LvDeviceFtr.LUTSelector, (UInt32)LvLUTSelector.Green);
