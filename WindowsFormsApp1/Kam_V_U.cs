    ...
    public class CCamera2
    {
        ...
        public void OpenCamera(IntPtr hDisplayWnd, LvSystem pSystem)
        {
            try
            {
                ...
                pDevice.SetFloat(LvDeviceFtr.LvUniBalanceRatio, 1.155000);
                ...
                pDevice.SetFloat(LvDeviceFtr.LvUniBalanceRatio, 1.203000);
        ...
        public void SaveImg(LvNewBufferEventArgs e)
        {
            ...
            e.Buffer.SaveImageToJpgFile(@"C:\Users\Damian.Jakubowski\AWICO\Technik - Witt IBC Bilder\VU" + name + ".jpg", 95);
        }
